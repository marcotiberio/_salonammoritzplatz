		...
		<div class="ticker-tape-small">
			<div class="inside">
				<svg class="first" width="2078" height="28" viewBox="0 0 2078 28">
					<text id="TEAM" data-name="TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM" transform="translate(1039 22)" fill="#e6e6e6" font-size="20" font-family="sam-arial-black" font-weight="800"><tspan x="-1038.916" y="0" xml:space="preserve">TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         TEAM         </tspan></text>
				</svg>
