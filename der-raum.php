		...
		<div class="ticker-tape-small">
			<div class="inside">
				<svg class="" width="2244" height="28" viewBox="0 0 2244 28">
					<text id="ERDGESCHOSS" data-name="ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         " transform="translate(1122 22)" fill="#e6e6e6" font-size="20" font-family="sam-arial-black" font-weight="800"><tspan x="-1121.055" y="0" xml:space="preserve">ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         </tspan></text>
				</svg>
				<svg width="2244" height="28" viewBox="0 0 2244 28">
					<text id="ERDGESCHOSS" data-name="ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         " transform="translate(1122 22)" fill="#e6e6e6" font-size="20" font-family="sam-arial-black" font-weight="800"><tspan x="-1121.055" y="0" xml:space="preserve">ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         EINDRÜCKE         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         </tspan></text>
				</svg>
				<svg width="2244" height="28" viewBox="0 0 2244 28">
					<text id="ERDGESCHOSS" data-name="ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         " transform="translate(1122 22)" fill="#e6e6e6" font-size="20" font-family="sam-arial-black" font-weight="800"><tspan x="-1121.055" y="0" xml:space="preserve">ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         EINDRÜCKE         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         ERDGESCHOSS         </tspan></text>
				</svg>
